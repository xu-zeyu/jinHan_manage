export default {
  ...
  'menu.finance': '财务管理',
  'menu.finance.financeDashboard': '财务概览',
  'menu.finance.financeIncome': '收入管理',
  'menu.finance.financeExpense': '支出管理',
  'menu.finance.financeReport': '财务报表',
